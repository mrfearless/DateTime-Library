...
;   to retrieve the year portion from. The format of the date & time string is 
...
;
;------------------------------------------------------------------------------
DTYear PROC FRAME lpszDateTimeString:QWORD, DateFormat:QWORD

    Invoke DTDateTimeStringToQwordDateTime, lpszDateTimeString, DateFormat
    
    ; rax has date CCYYMMDD format
    shr rax, 16 ; rax has year

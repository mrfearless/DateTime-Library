...
;
; Converts Julian date integer value and total milliseconds to DWORD values 
; containing date and time information. On return EAX contains the date 
; information and EDX the time information.
;
; Parameters:
;
; * JulianDate - A DWORD value containing the Julian date integer to convert 
;   to a DWORD date in EAX.
;
; * Milliseconds - A DWORD value containting the total milliseconds to convert
;   to hours, minutes, seconds and milliseconds in DWORD time in EDX.
;
; Returns:
;
...
;
;------------------------------------------------------------------------------
DTJulianMillisecToDwordDateTime PROC JulianDate:DWORD, Milliseconds:DWORD
    LOCAL _Date:DWORD
    ...
    ret
DTJulianMillisecToDwordDateTime ENDP
